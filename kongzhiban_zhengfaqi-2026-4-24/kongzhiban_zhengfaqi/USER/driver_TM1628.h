...
#define TM1628_STB_0    	GPIO_ResetBits(GPIOB,GPIO_Pin_11)//
#define TM1628_STB_1    	GPIO_SetBits(GPIOB,GPIO_Pin_11)
#define TM1628_DIO_0    	GPIO_ResetBits(GPIOB,GPIO_Pin_13)//
#define TM1628_DIO_1    	GPIO_SetBits(GPIOB,GPIO_Pin_13)
#define TM1628_CLK_0    	GPIO_ResetBits(GPIOB,GPIO_Pin_12)//
#define TM1628_CLK_1    	GPIO_SetBits(GPIOB,GPIO_Pin_12)
