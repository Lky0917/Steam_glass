...
选择BANK1-NORSRAM4 连接TFT,地址范围0x6c00 0000~0x6fff ffff
FSMC_A23 接LCD的DC(寄存器/数据选择)脚
寄存器基地址 = 0x6c00 0000
RAM基地址 = 0x6d00 0000 = 0x6c00 0000 + 2^23*2 
当选择不同地址线时，地址需重新计算
***********************************************************/
...
//*************************ILI9341 显示区域的起始坐标和总行列数
#define    ILI9341_DispWindow_X_Star       0
#define    ILI9341_DispWindow_Y_Star       0

#define    ILI9341_LESS_PIXEL              240  //液晶屏较短方向像素宽度
#define    ILI9341_MORE_PIXEL              320  //液晶屏较长方向像素宽度

//根据液晶扫描方向而变化的xy像素宽度
//调用ILI9341_GramScan函数设置方向时会自动更改
extern  unsigned int  LCD_X_LENGTH,LCD_Y_LENGTH;

//液晶屏扫描模式  参数可选值为0-7
extern  unsigned char LCD_SCAN_MODE;

//**********定义 ILI9341 显示屏常用颜色**********************
#define   BLACKGROUND       BLACK
...
void ILI9341_DisplayStringEx(uint16_t x, 		
									    uint16_t y, 	
										uint16_t Font_width,
