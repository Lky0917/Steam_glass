...
typedef struct
{
	...
	unsigned char BLErepair;//Åä¶Ô
	unsigned int  BlePairTime;//30sÅä¶ÔÊ±¼ä
	unsigned int  nCallightblepair;
...
unsigned char bYeweiLow      :1;//ÒºÎ»µÍÌáĞÑ
//zhendong
...
unsigned char bManuStartChugou   :1;//°´¼ü³ı¹¸


unsigned char bGetKeyOK:1;//°´¼ü½ÓÊÕ³É¹¦
}MCHINF;
